...
public class HttpSenderUtil {
    ...
    private static String port = "30363";

    public static void main(String[] strs) throws InterruptedException{
        String filename = "E:\\junior big\\gitRepo\\DistributedComputing\\order-testData\\order3.json";
        String contents = "";
        try {
        ...
        for (Order od : orderList) {
            ...
            String param = msg;
            String res = HttpSenderUtil.sendPost(url+port, param);
